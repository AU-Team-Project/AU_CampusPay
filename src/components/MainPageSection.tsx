        ...
        content: [
            {
                ...
                extra: '빠르고 쉬운 식권 인증 시스템.'
            }
        ]
    },
    {
        id: 'section2',
        bgClassName: 'bg-section2-color',
        images: [
            {
